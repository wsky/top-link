...
public class Text {
	...
	public static String REACH_MAX_IDLE_AND_CLOSE = "reach maxIdleTimeSeconds={}, close client channel";
	...
	public static String WS_CONNECTION_CLOSED_BY = "connection closed: {}|{}";
	...
	public static String SERVER_RUN = "server channel bind at {}";
	...
	public static String E_GOT_ERROR = "got error from {}: {}|{}";
	public static String E_CHANNEL_ERROR = "channel error";
	public static String E_ACCEPT = "{} accept a connect-in endpoint#{} and assign token#{}";
	public static String E_REFUSE = "refuse a connect-in endpoint";
	public static String E_CONNECT_SUCCESS = "sucessfully connect to endpoint#{}, and got token#{}";
	...
	public static String E_IDENTITY_NOT_MATCH_WITH_CALLBACK = "message's identity({}) not match callback's({})";
	public static String E_SINGLE_ALLOW = "only allow sinle endpoint connected on a channel";
	public static String E_UNKNOWN_MSG_TYPE = "uknown message type {}";
	...
	public static String RPC_PENDING_CALL = "pending methodCall#{}";
	public static String RPC_GET_RETURN = "receive methodReturn of methodCall#%s";
	public static String RPC_RETURN_ERROR = "remote reutrn error#{}: {}";

	public static String SCHEDULE_START = "scheduler start";
	public static String SCHEDULE_STOP = "scheduler stop";
	public static String SCHEDULE_GOT_MAX = "reach max task pending count {}";
	public static String SCHEDULE_TASK_REFUSED = "task refused";
	public static String SCHEDULE_TASK_DISPATCHED = "dispatch {} tasks";
